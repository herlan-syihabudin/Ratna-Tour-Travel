    ...
    <section className="relative h-[90vh] w-full flex items-center justify-center text-white">
      ...
      <div className="relative text-center px-6 max-w-3xl">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-10 text-sm md:text-base">
          <span className="bg-white/15 backdrop-blur px-4 py-2 rounded-full border border-white/20">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          <a
            ...
            target="_blank"
            className="bg-[#C29A45] hover:bg-[#b89238] transition text-white font-semibold px-8 py-4 rounded-lg flex items-center gap-2 text-lg shadow-lg"
          >
          ...
          <a
            href="#paket"
            className="border border-white/60 hover:border-white px-8 py-4 rounded-lg text-lg font-medium transition"
          >
            Lihat Paket Umroh
          </a>
        </div>
